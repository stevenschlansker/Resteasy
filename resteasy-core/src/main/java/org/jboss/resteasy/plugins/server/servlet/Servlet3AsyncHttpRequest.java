...
public class Servlet3AsyncHttpRequest extends HttpServletInputMessage {
    ...
    public Servlet3AsyncHttpRequest(final HttpServletRequest httpServletRequest, final HttpServletResponse response,
            final ServletContext servletContext, final HttpResponse httpResponse, final ResteasyHttpHeaders httpHeaders,
            final ResteasyUriInfo uriInfo, final String s, final SynchronousDispatcher synchronousDispatcher) {
    ...
    private class Servlet3ExecutionContext extends AbstractExecutionContext {
        ...
        Servlet3ExecutionContext(final ServletRequest servletRequest) {
            super(Servlet3AsyncHttpRequest.this.dispatcher, Servlet3AsyncHttpRequest.this,
                    Servlet3AsyncHttpRequest.this.httpResponse);
        ...
        @Override
        public void complete() {
            if (wasSuspended && asynchronousResponse != null)
